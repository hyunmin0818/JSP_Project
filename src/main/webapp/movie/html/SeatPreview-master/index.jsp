						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									...
									<span class="intro__down">Sintel <span class="intro__partial"><em>by</em> <a href="../anime-details.html">Bonobono</a></span></span>
								</h2>
							</div>
							<div class="intro__side">
								<button class="action action--seats">좌석보기</button>
							</div>
						</div>
					</div>
				</div>
