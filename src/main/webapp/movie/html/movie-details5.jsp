							...
							<div class="col-lg-4 col-md-4">
								<div class="anime__details__sidebar">
									...
									<div class="product__sidebar__view__item set-bg"
										data-setbg="${pageContext.request.contextPath}/movie/html/img/sidebar/tv-1.jpg">
									...
									<div class="product__sidebar__view__item set-bg"
										data-setbg="${pageContext.request.contextPath}/movie/html/img/sidebar/tv-2.jpg">
									...
									<div class="product__sidebar__view__item set-bg"
										data-setbg="${pageContext.request.contextPath}/movie/html/img/sidebar/tv-3.jpg">
									...
									<div class="product__sidebar__view__item set-bg"
										data-setbg="${pageContext.request.contextPath}/movie/html/img/sidebar/tv-4.jpg">
