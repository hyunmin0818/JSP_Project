					...
					<div class="login__form">
						...
						<form action="${pageContext.request.contextPath}/SubmitOk.ms"
							...
							<div class="findIdPw_link" align="center">
								<label><input type="checkbox" id="check_saveId">
									<a class="blacktext" id="saveId">아이디 저장</a></label>
								<t>|</t>
								<a href="./findId.jsp" class="blacktext">아이디 찾기 </a>| <a
									href="./findPw.jsp" class="blacktext">비밀번호 찾기</a>
							</div>
