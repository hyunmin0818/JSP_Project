...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-2">
					<div class="header__right">
						...
						<a href="./login.jsp" id="youNeedLogin">로그인</a>| <a
							href="./join.jsp" id="youNeedJoin">회원가입 </a>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb__links">
						<!-- 홈으로 이동하는 링크 -->
						<a href="${pageContext.request.contextPath}/movie/html/index.jsp"><i
	...
	<div class="css-yy4d6f e1yew28617"
		...
		<div class="css-stilcut"
			style="background-attachment: fixed; background: url(https://an2-img.amz.wtchn.net/image/v2/UdinY7L06PQParoTrP1TAQ.jpg?jwt=ZXlKaGJHY2lPaUpJVXpJMU5pSjkuZXlKdmNIUnpJanBiSW1SZk1Ua3lNSGd4TURnd2NUZ3dJbDBzSW5BaU9pSXZkakl2YzNSdmNtVXZhVzFoWjJVdk1UQTJORGszTURBd056VTBOVGd4SW4wLk1RY1RhRC1YcXVPQ0VheG1SMmdiSFIzWEZ1RHpVRlVMU2ZOUEFXXzhxSlk) no-repeat center;">


			<div class="css-sdsdsd">

				<h1 class="css-Title">${movie.title}</h1>
				<div class="css-qnwpahr">${movie.title}</div>
				...
				<div class="row" style="margin-top: 30px;">
					...
					<div class="col-lg-3">
						<div class="anime__details__pic set-bg"
							data-setbg="img/anime/popular-1.jpg">
							<!--이미지-->
							<div class="comment">
					...
					<div class="col-lg-9">
						<div class="anime__details__text">
							...
							<!-- 영화 설명 -->
							<p>미국 LA, 거액의 의뢰를 받은 무당 ‘화림’(김고은)과 ‘봉길’(이도현)은 기이한 병이 대물림되는
								집안의 장손을 만난다. 조상의 묫자리가 화근임을 알아챈 ‘화림’은 이장을 권하고, 돈 냄새를 맡은 최고의 풍수사
								‘상덕’(최민식)과 장의사 ‘영근’(유해진)이 합류한다. “전부 잘 알 거야… 묘 하나 잘못 건들면 어떻게 되는지”
								절대 사람이 묻힐 수 없는 악지에 자리한 기이한 묘. ‘상덕’은 불길한 기운을 느끼고 제안을 거절하지만, ‘화림’의
								설득으로 결국 파묘가 시작되고… 나와서는 안될 것이 나왔다.</p>
							<!-- 영화 세부 정보 표 -->
							<div class="anime__details__widget">
								<div class="row">
									<div class="col-lg-6 col-md-6">
										<ul>
											<li><span>유형:</span> TV Series</li>
											<!--유형-->
											<li><span>회사:</span> ㈜쇼박스</li>
											<!--제작사-->
											<li><span>개봉일:</span> 2024.02.22.</li>
											<!--방영일-->
											<li><span>국가:</span> 한국</li>
											<!--국가-->
											<li><span>장르:</span> 미스터리,공포</li>
											<!--장르-->
										</ul>
									</div>
									<div class="col-lg-6 col-md-6">
										<ul>
											<li><span>배우:</span> 최민식,유해진,이도현,김고은</li>
											<!--배우-->
											<li><span>평점:</span> 8.5 / 161 times</li>
											<!--평가-->
											<li><span>상영시간:</span> 134 분</li>
											<!--재생시간-->
											<li><span>등급:</span> 15세 관람가</li>
											<!--등급-->
											<li><span>예매 인원:</span> 131,541</li>
											<!--조회수-->
										</ul>
									</div>
								</div>
								...
								<c:forEach var="comment" items="${commentList }">
									<div class="movie__review__item">
										...
										<div class="movie__review__item__text">
											<h6>
												${comment.user_id}<span>${comment.commentTime}</span>
											</h6>
											<p>${comment.comment }</p>
				...
				<div class="col-lg-4 col-md-4">
					<div class="anime__details__sidebar">
						...
						<div class="product__sidebar__view__item set-bg"
							...
							<h5>
								<a
									href="${pageContext.request.contextPath}/movie/html/movie-details.jsp=?${movie.movieSeq}">Boruto:
	...
	<script
		src="${pageContext.request.contextPath}/movie/html/js/ajaxForLikes.js"></script>
