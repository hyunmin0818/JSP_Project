        ...
        <div class="container">
            <div class="row" >
                    ...
                    <div class="login__form" id ="logincenter">
                        ...
                        <form action="${pageContext.request.contextPath}/movie/web/joinOk.ms" method="post">               <!--입력창 활성화 -->
                            <div>
                            ...
                            <h5 align="left" class="whitetext">이름<a id="check_name_message"></a></h5><br>
                            <div class="input__item">
                            ...
                            <h5 align="left" class="whitetext">생년월일<a id="check_birth_message"></a></h5><br>  
                            <div class="input__item">
                                <input type="date" placeholder="법정생년월일 6자리를 입력해주세요" id="userbirth" name="userbirth">
                                <span class="icon_lock"></span>
                            </div>

                            <h5 align="left" class="whitetext">휴대번호<a id="check_phone_message"></a></h5><br>
                            <div class="input__item">
                                
                                <input type="text" placeholder="휴대번호를 입력해주세요 (010,011)" id="userphone" name= "userphone">
                                <span class="icon_mail"></span>
                            </div>
                            <h5 align="left" class="whitetext">이메일<a id="check_email_message"></a></h5><br>
                            <div class="input__item">
                            ...
                            <button type="submit" class="site-btn" id="join_submit">가입</button>
                        </form>
                       <br> <br> <br> <br> <br> <br>
                    </div>
