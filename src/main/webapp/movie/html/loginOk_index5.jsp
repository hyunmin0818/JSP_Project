...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            ...
                            <a href="${pageContext.request.contextPath}/movie/clickPoster.mo?movieSeq=<%=movie.getMovieSeq()%>" class="moviePoster">
                            ...
                            <div class="product__item__text">
                                ...
                                <h5><a href="movie-details.jsp?movieSeq=<%=movie.getMovieSeq()%>"><%=movie.getTitle()%></a></h5>
                            </div>
                        </div>
                    </div>
                    <% } %>
	...
	<script
		src="https://cdn.jsdelivr.net/npm/nouislider/distribute/nouislider.min.js"></script>
	<script
		src="https://cdn.jsdelivr.net/npm/@babel/polyfill/dist/polyfill.min.js"></script>
	<script
		src="${pageContext.request.contextPath}/movie/html/js/date-slider.js"></script>
</body>
