...
<body>
    <%-- 사용자 로그인 상태 확인 --%>
    <% boolean isLoggedIn=false; String userId=null; if (session.getAttribute("userinfo") !=null) {
        isLoggedIn=true; userId=((UserDTO)session.getAttribute("userinfo")).getUser_id(); } %>
    <%-- 로그인 상태에 따른 메뉴 표시 --%>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10"> <!-- 수정 -->
                                                <div class="header__right">
                                                    <% if (isLoggedIn) { %>
                                                        <!-- 로그인 상태일 때 보여질 내용 -->
                                                        <a href="#" class="search-switch"><span
                                                        ...
                                                        <% } else { %>
                                                            ...
                                                            <a href="./login.jsp" id="youNeedLogin">로그인</a> | <a
                                                                href="movie/html/join.jsp" id="youNeedJoin">회원가입</a>
                                                            <% } %>
                                                </div>
                                            </div>
                                        </div>
