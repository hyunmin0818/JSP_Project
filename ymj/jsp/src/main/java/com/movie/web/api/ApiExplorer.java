...
public class ApiExplorer {
    public static void main(String[] args) throws IOException { 
        ...
        /*URL*/ urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=H594OAKW457U2H270K93");
        /*Service Key*/ urlBuilder.append("&" + URLEncoder.encode("val001","UTF-8") + "=" + URLEncoder.encode("2018", "UTF-8")); 
        ...
        String line; while ((line = rd.readLine()) != null) { sb.append(line); } rd.close(); conn.disconnect(); System.out.println(sb.toString()); 
